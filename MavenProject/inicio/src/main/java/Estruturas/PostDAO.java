...
public LinkedList<Post> getAllForumPosts(int forumIdP, int userIDP, int categoriaP) {
    LinkedList<Post> posts = new LinkedList<Post>();
    
    // Defina a consulta SQL base
    String sql = "SELECT * FROM posts WHERE 1=1"; //1=1 é uma condição verdadeira, então não afeta a consulta possibilita usar ands e ors

    // Lista para manter os parâmetros a serem vinculados à consulta
