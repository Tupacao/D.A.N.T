...
public class AddGamesFromJson {
  ...
  public static void main(String[] args) { //main
       ...
       String jsonFilePath = "C:/Users/Gaok1/Documents/GitHub/D.A.N.T/MavenProject/inicio/src/main/java/Games.json";
 // Altere para o caminho do seu arquivo JSON
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(jsonFilePath))) {
            ...
            JsonArray appsArray = jsonObject.getAsJsonObject("applist").getAsJsonArray("apps");
